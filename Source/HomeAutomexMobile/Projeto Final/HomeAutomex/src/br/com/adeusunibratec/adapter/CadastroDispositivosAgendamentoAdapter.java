...
public class CadastroDispositivosAgendamentoAdapter extends BaseExpandableListAdapter {
	...
	public CadastroDispositivosAgendamentoAdapter(Context context, List<String> listDataHeader,
	...
	public View getChildView(int groupPosition, final int childPosition,
		...
		if (convertView == null) {
			...
			convertView = infalInflater.inflate(R.layout.list_item_cadastrodispositivoagendamento,
					null);
		}
