	...
	public class ResidenciaTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String jResult) {
			...
			for (Iterator it = lista.iterator(); it.hasNext();) {
				...
				for (int a =0; a<descri.size(); a++) {
					
					  
					//descr.add(descri.get(a)+descricaoCenario.getChaveAmbiente());
					  
					  descr.add("{"+descri.get(a)+"\"chaveCenario\":"+descricaoCenario.getChaveAmbiente()+"}");
					
					  /* "{\"Descricao\":"+descri.get(a)+"\"chaveCenario",}"*/
					      Log.e("teste louco","aqui o"+ descri.get(a));
				}
