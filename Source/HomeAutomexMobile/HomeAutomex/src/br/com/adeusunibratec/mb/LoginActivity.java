...
public class LoginActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.loginEdit = (EditText) findViewById(R.id.editText1);
		this.loginEdit.setFocusable(true);
		this.loginEdit.requestFocus();

		this.senhaEdit = (EditText) findViewById(R.id.editText2);

		this.logarBtn = (Button) findViewById(R.id.button1);
	...
	private void showHomeActivity(String jResult) {
		/*Intent intent = new Intent(LoginActivity.this, TesteLoginActivity.class);
